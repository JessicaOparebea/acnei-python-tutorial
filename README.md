...
| 05 | [Functions](notebooks/05_functions.ipynb) | def, return, defaults, *args, **kwargs, lambda |
| 06 | [Libraries](notebooks/06_libraries.ipynb) | math, numpy, matplotlib — with neuroscience plots |

> Solutions to all exercises live in the [`solutions/`](solutions/) folder.
